...
def compute_average_ndcg(questions_file_path, results_file_path, k=10):
    ...
    with open(results_file_path, 'r') as f:
        for line in f:
            ...
            retrieved_docs = [doc.split(':')[1] for doc in retrieved_docs]
...
def main():
    ...
    parser.add_argument('--results_file', type=str, help="Path to the ranked results file (JSONL).", default='output/ranked_questions.jsonl')
